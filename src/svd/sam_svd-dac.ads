...
package SAM_SVD.DAC is
   ...
   type DAC_DACCTRL_Register is record
      ...
      --  Refresh period
      REFRESH        : DACCTRL_REFRESHSelect := SAM_SVD.DAC.REFRESH_0;
      --  unspecified
      Reserved_12_12 : HAL.Bit := 16#0#;
      --  Sampling Rate
      OSR            : DACCTRL_OSRSelect := SAM_SVD.DAC.OSR_1;
   end record
